...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,api.morphbreak.site").split(",")


# Application definition

INSTALLED_APPS = [
    "jazzmin",  # Modern admin UI theme - must be before django.contrib.admin
...
cors_origins_str = os.environ.get("CORS_ALLOWED_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,https://morphbreak.site,https://www.morphbreak.site")
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Security Scanner Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Security Scanner",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Security Scanner Platform",
    ...
    "welcome_sign": "Welcome to Security Scanner Admin",

    # Copyright on the footer
    "copyright": "Security Scanner Platform",
    ...
    "usermenu_links": [
        {"name": "Frontend Site", "url": FRONTEND_URL, "new_window": True},
        {"model": "auth.user"}
    ],
    ...
    "custom_links": {
        "scanning": [{
            "name": "Start New Scan",
            "url": "admin:scanning_scan_add",
            "icon": "fas fa-play-circle",
            "permissions": ["scanning.add_scan"]
        }]
    },
    ...
    "icons": {
        ...
        "authentication.CustomUser": "fas fa-user-shield",
        "projects.Project": "fas fa-project-diagram",
        "scanning.Scan": "fas fa-search",

...
class NucleiAdapter:
        ...
        try:
            ...
            try:
                ...
                cmd = [
                    ...
                    output_file,
                    "-timeout",
                    "5",  # 5 second timeout for passive checks
            ...
            logger.error(
                f"Nuclei execution error: {e.stderr.decode() if e.stderr else str(e)}"
            )
            findings.append(
                {
    ...
    def _run_nuclei_passive(self):
        ...
        try:
            ...
            if hasattr(self, "available_tools") and isinstance(

...
class ScanConfiguration(models.Model):
    ...
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name="scan_configurations"
    )
    ...
    reduce_false_positives = models.BooleanField(
        default=False, help_text="Use enhanced scanning tools to reduce false positives"
    )
...
class CrawlResult(models.Model):
    ...
    scan = models.OneToOneField(
        Scan, on_delete=models.CASCADE, related_name="crawl_result"
    )
...
class AjaxSpiderResult(models.Model):
    ...
    scan = models.OneToOneField(
        Scan, on_delete=models.CASCADE, related_name="ajax_spider_result"
    )

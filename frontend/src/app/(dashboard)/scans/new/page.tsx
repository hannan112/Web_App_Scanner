        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* Passive Scan Tools */}
              <div className="space-y-4">
                <h3 className="text-md font-medium text-gray-900">Passive Analysis Tools</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 rounded border-gray-300"
                    />
                    <label htmlFor="use_zap_passive" className="ml-2 block text-sm text-gray-700">
              ...
              {isActiveScanning && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="enable_spider" className="ml-2 block text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="enable_ajax_spider" className="ml-2 block text-sm text-gray-700">
                          Enable AJAX Spider
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_sql_injection" className="ml-2 block text-sm text-gray-700">
                          SQL Injection
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_xss" className="ml-2 block text-sm text-gray-700">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_csrf" className="ml-2 block text-sm text-gray-700">
                          CSRF
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_authentication" className="ml-2 block text-sm text-gray-700">
                          Authentication
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_authorization" className="ml-2 block text-sm text-gray-700">
                          Authorization
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_session_management" className="ml-2 block text-sm text-gray-700">
                          Session Management
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_command_injection" className="ml-2 block text-sm text-gray-700">
                          Command Injection
                        </label>
                      </div>
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-blue-600 rounded border-gray-300"
                        />
                        <label htmlFor="test_xxe" className="ml-2 block text-sm text-gray-700">
                          XXE Injection
                        </label>
                      </div>
                    </div>
                  ...
                  {customConfigs.test_sql_injection && (
                    <div className="space-y-4">
                      <h3 className="text-md font-medium text-gray-900">SQL Injection Testing Tools</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="use_sqlmap" className="ml-2 block text-sm text-gray-700">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="max_concurrent_requests" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    id="use_enhanced_discovery"
                    name="use_enhanced_discovery"
                    checked={customConfigs.use_enhanced_discovery}
                    onChange={handleCustomConfigChange}
                    className="h-4 w-4 text-blue-600 rounded border-gray-300"
                  />
                  <label htmlFor="use_enhanced_discovery" className="ml-2 block text-sm text-gray-700">
                ...
                {customConfigs.use_enhanced_discovery && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
                    <div>
                      <label htmlFor="discovery_timeout" className="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <input
                        ...
                        min="10"
                        max="300"
                        value={customConfigs.discovery_timeout}
                        onChange={handleCustomConfigChange}
                        className="w-full p-2 border border-gray-300 rounded-md"
                      />
                      <p className="mt-1 text-xs text-gray-500">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="10"
                        max="1000"
                        value={customConfigs.max_subdomains}
                        onChange={handleCustomConfigChange}
                        className="w-full p-2 border border-gray-300 rounded-md"
                      />
                      <p className="mt-1 text-xs text-gray-500">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="10"
                        max="1000"
                        value={customConfigs.max_wayback_urls}
                        onChange={handleCustomConfigChange}
                        className="w-full p-2 border border-gray-300 rounded-md"
                      />
                      <p className="mt-1 text-xs text-gray-500">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="10"
                        max="500"
                        value={customConfigs.max_directories}
                        onChange={handleCustomConfigChange}
                        className="w-full p-2 border border-gray-300 rounded-md"
                      />
                      <p className="mt-1 text-xs text-gray-500">
                        Maximum directories to brute-force (10-500)
                      </p>
                    </div>
                  </div>
                )}

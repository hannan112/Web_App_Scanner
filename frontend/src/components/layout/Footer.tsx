        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/projects" className="text-sm hover:text-white transition">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/scans" className="text-sm hover:text-white transition">
                  Scans
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://owasp.org/www-project-top-ten/" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition">
                  OWASP Top 10
                </a>
              </li>
              <li>
                <a href="https://www.zaproxy.org/" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition">
                  OWASP ZAP
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              Built with ❤️ using Django, Next.js, and OWASP security tools
            </p>
          </div>
        </div>
      </div>

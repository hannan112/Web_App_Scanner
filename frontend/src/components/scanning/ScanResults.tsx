                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        safeGetNestedValue(sanitizedPassiveReconData, 'server_info.is_https', false)
                      ...
                      {safeGetNestedValue(sanitizedPassiveReconData, 'enhanced_discovery.api_endpoints.api_endpoints', []).map((endpoint: any, index: number) => (
                        <div key={index} className="flex items-center justify-between text-sm">
                          ...
                          {typeof endpoint === 'object' && endpoint.status ? (
                            <span className={`px-2 py-0.5 rounded text-xs font-medium w-12 text-center ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                      ...
                      <div>
                        ...
                        <span className={`ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${
                          form.method === 'POST' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                        }`}>

...
class ProjectAPITest(APITestCase):
    ...
    def test_list_projects(self):
        Project.objects.create(name='Project 1', target_url='https://example.com', owner=self.user)
        Project.objects.create(name='Project 2', target_url='https://example.org', owner=self.user)
